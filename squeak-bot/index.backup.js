// SQUEAK Bot – Telegraf (Codespaces/Render ready)
...
const JUP  = `https://jup.ag/swap/SOL-SQUEAK?outputMint=${MINT}`;
...
`🐭 <b>Welcome to SQUEAK</b> — the funniest meme coin on Solana! 🧀
